...
const BC = require('./3_blockchain')
const p2pserver = require('./3_network')
const {initWallet,getPublicKeyFromWallet} = require('./3_wallet');
const {importBlockDB} = require('./3_util')
