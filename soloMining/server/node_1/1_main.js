...
const BC = require('./1_blockchain')
const p2pserver = require('./1_network')
const {initWallet,getPublicKeyFromWallet} = require('./1_wallet');
const {importBlockDB} = require('./1_util')
...
p2pserver.connectToPeers(["ws://localhost:6001","ws://localhost:6002","ws://localhost:6003","ws://localhost:6004"]);
