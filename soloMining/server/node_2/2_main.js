...
const BC = require('./2_blockchain')
const p2pserver = require('./2_network')
const {initWallet,getPublicKeyFromWallet} = require('./2_wallet');
const {importBlockDB} = require('./2_util')
